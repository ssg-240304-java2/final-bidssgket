...
public class QProductImage extends EntityPathBase<ProductImage> {
    ...
    private static final long serialVersionUID = 1236090750L;
    ...
    public final NumberPath<Long> productImgNo = createNumber("productImgNo", Long.class);

    public final BooleanPath productThumbnail = createBoolean("productThumbnail");
